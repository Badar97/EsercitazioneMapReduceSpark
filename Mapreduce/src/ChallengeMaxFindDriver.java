...
public class ChallengeMaxFindDriver extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		int exitCode =ToolRunner.run(new ChallengeMaxFindDriver(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ChallengeMaxFindDriver.class); // Indico la classe che costituirà l'entry point del job

		

		job.setMapperClass(ChallengeMaxFindMapper.class);
		job.setReducerClass(ChallengeMaxFindReducer.class);

		// #TODO: inserire 12 per la consegna
		job.setPartitionerClass(ChallengeMaxFindPartitioner.class);
