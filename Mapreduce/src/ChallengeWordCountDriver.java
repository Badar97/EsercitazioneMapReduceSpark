...
public class ChallengeWordCountDriver extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		int exitCode =ToolRunner.run(new ChallengeWordCountDriver(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ChallengeWordCountDriver.class); // Indico la classe che costituirà l'entry point del job
		job.setMapperClass(ChallengeWordCountMapper.class);
		job.setReducerClass(ChallengeWordCountReducer.class);
